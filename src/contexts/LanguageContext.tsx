...
const translations: TranslationsType = {
  en: {
    ...
    'learning.limitedAccessWarning': 'Limited Access Mode',
    'learning.limitedAccessDescription': 'Sign in to save your progress and access all features',
    ...
    'lesson.restartLesson': 'Restart Lesson',
    ...
    'lesson.completedMessage': 'You have successfully completed this lesson! Great job!',
    'lesson.congratulations': 'Congratulations!',
    'lesson.summary': 'Summary',
    'lesson.noSummary': 'No summary available for this lesson.',
    'lesson.funFacts': 'Fun Facts',
    'lesson.activity': 'Activity',
    'lesson.tryActivity': 'Try This Activity',
    'lesson.create': 'Create Lesson',
    'lesson.readAloud': 'Read Aloud',
    'lesson.reading': 'Reading...',
    'lesson.storyMode': 'Story Mode',
    'lesson.storyModeOn': 'Story Mode On',
    'lesson.storyIntro': 'Start your adventure! Click next to begin.',
    'lesson.nextStep': 'Next Step',
    'lesson.loading': 'Loading...',
    'lesson.loadingLesson': 'Loading your personalized lesson...',
    'lesson.aiGenerating': 'Our AI is creating an engaging learning experience just for you!',
    'lesson.errorLoadingLesson': 'Error loading lesson',
    'lesson.noLessonContent': 'Lesson content is unavailable or corrupted. Please try again later.',
    'lesson.retry': 'Retry',
    'lesson.progress': 'Progress',
    'lesson.loadingImage': 'Loading image...',
    ...
    'quiz': 'Quiz',
    'game': 'Game',
    'quiz.whyWrong': 'Why did I get this wrong?',
    'quiz.streak': 'Streak',
    'quiz.retry': 'Retry',
    'quiz.finish': 'Finish',
    'quiz.scores': 'Quiz Scores',
    'quiz.streaks': 'Streaks',
    'badge.earned': 'Badges Earned',
  ...
  id: {
    ...
    'lesson.startLesson': 'Mulai Pelajaran',
    'lesson.newLesson': 'Pelajaran Baru',
    'lesson.restartLesson': 'Mulai Lagi Pelajaran',
    'lesson.backToDashboard': 'Kembali ke Dasbor',
    ...
    'lesson.completedMessage': 'Anda telah berhasil menyelesaikan pelajaran ini! Selamat!',
    'lesson.congratulations': 'Selamat!',
    'lesson.summary': 'Ringkasan',
    'lesson.noSummary': 'Tidak ada ringkasan untuk pelajaran ini.',
    'lesson.funFacts': 'Fakta Menarik',
    'lesson.activity': 'Aktivitas',
    'lesson.tryActivity': 'Coba Aktivitas Ini',
    'lesson.create': 'Buat Pelajaran',
    'lesson.readAloud': 'Bacakan',
    'lesson.reading': 'Sedang dibacakan...',
    'lesson.storyMode': 'Mode Cerita',
    'lesson.storyModeOn': 'Mode Cerita Aktif',
    'lesson.storyIntro': 'Mulai petualanganmu! Klik berikutnya untuk memulai.',
    'lesson.nextStep': 'Langkah Berikutnya',
    'lesson.loading': 'Memuat...',
    'lesson.loadingLesson': 'Memuat pelajaran personalisasi Anda...',
    'lesson.aiGenerating': 'AI kami sedang menciptakan pengalaman belajar yang menarik khusus untuk Anda!',
    'lesson.errorLoadingLesson': 'Gagal memuat pelajaran',
    'lesson.noLessonContent': 'Konten pelajaran tidak tersedia atau rusak. Silakan coba lagi nanti.',
    'lesson.retry': 'Coba Lagi',
    'lesson.progress': 'Kemajuan',
    'lesson.loadingImage': 'Memuat gambar...',
    'lesson.chapter': 'Bab',
    'lesson.of': 'dari',
    ...
    'quiz': 'Kuis',
    'game': 'Permainan',
    'quiz.whyWrong': 'Kenapa saya salah?',
    'quiz.streak': 'Rangkaian',
    'quiz.retry': 'Coba Lagi',
    'quiz.finish': 'Selesai',
    'quiz.scores': 'Skor Kuis',
    'quiz.streaks': 'Rangkaian',
    'badge.earned': 'Lencana Diperoleh',
